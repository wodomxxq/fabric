...
Draw.prototype={
    ...
    font: function(x,y,x1,y1){
        this.init();
//      this.obj.beginPath();
        this.obj.font="40px '微软雅黑'";
        var test = 'sss'+ '\r' + '33'
        this.obj.fillText(test,x,y);
    },
    ...
    horizontalfont: function(x,y,x1,y1){ //、横线
        this.init();
        this.obj.beginPath();
        this.obj.moveTo(x,y);
        this.obj.lineTo(x1,y);
        this.obj.stroke();
    },
    verticalfont: function(x,y,x1,y1){ //、竖线
        this.init();
        this.obj.beginPath();
        this.obj.moveTo(x,y);
        this.obj.lineTo(x,y1);
        this.obj.stroke();
    },
